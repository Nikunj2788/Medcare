		...
		<div class="basic-breadcrumb-area bg-opacity bg-1 ptb-100">
			<div class="container">
				<div class="basic-breadcrumb text-center">
					<h3 class="">Product Right Sidebar</h3>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-9 col-sm-12">
						<div class="row mb-40">
							...
							<div class="col-md-6 col-sm-7 col-xs-3">
								...
								<div class="select-option f-right hidden-xs">
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="home">
									...
									<div class="col-md-4 col-sm-4 mb-30">
										<div class="product-box">
											<div class="product-img">
												<a href="product-details.html"><img src="img/product/7.jpg" alt="" /></a>
												<div class="action-box">
													<a href="#"><i class="ion-bag"></i></a>
													<a href="#"><i class="ion-ios-search-strong"></i></a>
													<a href="#"><i class="ion-heart"></i></a>
									...
									<div class="col-md-4 col-sm-4 mb-30">
										<div class="product-box">
											<div class="product-img">
												<a href="product-details.html"><img src="img/product/8.jpg" alt="" /></a>
												<div class="action-box">
													<a href="#"><i class="ion-bag"></i></a>
													<a href="#"><i class="ion-ios-search-strong"></i></a>
													<a href="#"><i class="ion-heart"></i></a>
									...
									<div class="col-md-12 col-sm-12 shop-list">
										<div class="product-box mb-30">
											...
											<div class="product-content">
												...
												<p>Pellentesque rutrum dictum ex, ac rutrum libero vulputate id. Pellentesque et risus mattis, congue metus vel, pulvinar orci. Phasellus dictum dui ut orci tincidunt, quis tincidunt nisl lobortis. In a dictum quam. Aenean cursus leo ante.</p>
												<div class="action-box">
													<a href="#"><i class="ion-bag"></i></a>
													<a href="#"><i class="ion-ios-search-strong"></i></a>
													<a href="#"><i class="ion-heart"></i></a>
					...
					<div class="col-md-3 col-sm-12">
						...
						<div class="shop-sidebar">
							<h3 class="sidebar-title">Best Product</h3>

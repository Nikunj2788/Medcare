...
<!-- 								<li><span>Call Us : </span> +123456789</li>
 -->							</ul>						
		...
		<!-- header end -->
		<!-- breadcrumb area -->
		<div class="basic-breadcrumb-area bg-opacity bg-1.jpg ptb-100">
			<div class="container">
				<div class="basic-breadcrumb text-center">
					<h3 class="">Take A mental Health Test</h3>
					<h4 class =""> Online Screening is one of the quickest and easiest ways to determine whether you are experiencing symptoms of a mental health condition. </h4>
					<h3 class =""> Mental health conditions, such as depression or anxiety, are real, common and treatable. And recovery is possible.</h3>
				</div>
			</div>
		</div>	
		<!-- breadcrumb area -->		
						...
						<div class="account-form">
							...
							<form method="post">
									...
									<div class="col-md-4 form-group">
										<a class="btn btn-block btn-round btn-base" href="Depression.jsp">  DEPRESSION TEST</a>
									</div>
									
									<div class="col-md-4 form-group">
										<a class="btn btn-block btn-round btn-base" href="Anxiety.jsp">ANXIETY TEST</a>
									</div>
									
									<div class="col-md-4 form-group">
										<a class="btn btn-block btn-round btn-base" href="Youth-test.jsp">YOUTH TEST</a>
									</div>
									
									<div class="col-md-4 form-group">
										<a class="btn btn-block btn-round btn-base" href="Addiction.jsp">ADDICTION TEST</a>
									</div>
						...
						<div class="col-md-3 mb-40">					   
							<div class="footer-widget">						
								...
								<div class="contact-widget">
									<ul>
										<li>
											<i class="fa fa-home"></i><p>Medcare link Ltd, Manhattan 1258, New York, USA Lahore</p>	
										</li>
										<li>
											<i class="fa fa-globe"></i><p><a href="#.">www.Medcare.com</a></p>	
										</li>
										<li>

...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/bootstrap_table.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:33 GMT -->
        ...
        <ul>
          <li class="mm-active"><a href="#">Elements</a>
              <ul>
                  ...
                  <li><a class="active" href="bootstrap_table.html">Grid Tables</a></li>

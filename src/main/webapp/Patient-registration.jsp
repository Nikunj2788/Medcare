			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2">
						<form action="PatientController" method="post" name="form" enctype="multipart/form-data">
							<div class="row">
							<div class="col-md-6 form-group">
								...
								<div class="col-md-6 form-group">
									...
									<input type="text" class="form-control input-lg" name="age" placeholder="Age" >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
								...
								<div class="col-md-6 form-group">
									...
									<input type="text" class="form-control input-lg" name="bloodgroup" placeholder="Blood group" >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Disease</label>
									<input type="text" class="form-control input-lg" name="disease" placeholder="Disease" >
									<p class="help-block text-danger"></p>
								</div>

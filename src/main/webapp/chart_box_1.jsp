...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/chart_box_1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:31 GMT -->
 ...
 <nav class="sidebar">
    ...
    <ul id="sidebar_menu">
        ...
        <li class="mm-active">
          ...
          <ul>
            <li><a class="active" href="chart_box_1.html">Chart Boxes 1</a></li>

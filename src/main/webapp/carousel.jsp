...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/carousel.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:31 GMT -->
        ...
        <ul>
          ...
          <li class="mm-active"><a href="#">Components</a>
              <ul>
                  ...
                  <li><a class="active" href="carousel.html">Carousel</a></li>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img src="admin/img/banner.png" class="d-block w-100" alt="...">
                              </div>

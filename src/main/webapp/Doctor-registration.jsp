			...
			<div class="menu-area ">
				<div class="container md-full xs-full">
					<div class="row">
						<div class="col-md-3">
							<div class="logo">
								<a href="index.html"><img style="height: 40px;" src="img/logo1.png" alt="" /></a>
							</div>
						</div>
						<div class="col-md-9">
		...
		<div class="basic-contact-form ptb-90">
			<div class="container">
				...
				<div class="row">
					...
					<!-- 	private String image,fname,lname,email,contact,address,birthdate,bloodgroup,qualification,experience,specialization,password;
					 -->
						<form action="DoctorController" method="post" name="form" enctype="multipart/form-data">
							<div class="row">
							<div class="col-md-6 form-group">
								...
								<div class="col-md-6 form-group">
									...
									<input type="text" class="form-control input-lg" name="contact" placeholder="Contact" >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Age</label>
									<input type="text" class="form-control input-lg" name="address" placeholder="Age" >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">birthdate</label>
									<input type="text" class="form-control input-lg" name="birthdate" placeholder="birthdate" >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">bloodgroup</label>
									<input type="text" class="form-control input-lg" name="bloodgroup" placeholder="bloodgroup" >
									<p class="help-block text-danger"></p>
								</div>
								
								<div class="col-md-6 form-group">
									<label class="sr-only">qualification</label>
									<input type="text" class="form-control input-lg" name="qualification" placeholder="qualification" >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">specialization</label>
									<input type="text" class="form-control input-lg" name="specialization" placeholder="specialization" >
									<p class="help-block text-danger"></p>
								</div>

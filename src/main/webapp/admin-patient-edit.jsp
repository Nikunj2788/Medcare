...
<body class="crm_body_bg">
    <%
	Patient p = (Patient)request.getAttribute("ss");
%>
 ...
 <nav class="sidebar">
    ...
    <ul id="sidebar_menu">
        ...
        <li>
          ...
          <ul>
            <li><a class="active" href="admin-index.jsp">Dashboard 1</a></li>
        ...
        <li class="">
          ...
          <ul>
            <li><a href="admin-doctor-list.jsp">Doctor List</a></li>
            <li><a href="admin-patient-list.jsp">Patient List</a></li>
                                ...
                                <div class="modal-content cs_modal">
                                    ...
                                    <div class="modal-body">
                                        <form action="PatientController" method="post">
                                            ...
                                            <label>Id</label>
                                                <input type="text" class="form-control" name="id" value=<%=p.getId() %>>
                                            </div>
                                            <div class="form-group">
                                            <label>First Name</label>
                                                <input type="text" class="form-control" name="fname" value=<%=p.getFname() %>>
                                            </div>
                                            <div class="form-group"><label>Last Name</label>
                                                <input type="text" class="form-control" name="lname"  value=<%=p.getLname() %>>
                                            </div>
                                            <div class="form-group">
                                            <label>Email</label>
                                            ...
                                            <div class="form-group">
                                            <label>Contact</label>
                                                <input type="number" class="form-control"  name="contact" value=<%=p.getContact() %>>
                                            </div>
                                            <div class="form-group">
                                            <label>Age</label>
                                                <input type="number" class="form-control" name="age" value=<%=p.getAge() %>>
                                            </div>
                                            <div class="form-group">
                                            <label>Address</label>
                                            ...
                                            <label>Birthdate</label>
                                                <input type="text" class="form-control" name="birthdate" value=<%=p.getBirthdate() %>>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                            <input type="submit" name="action"  class="btn_1" data-toggle="modal" data-target="#addcategory" class="btn_1 full_width text-center" 
														value="update_data"></div>
                                        </form>

...
<html class="no-js" lang="">
    ...
    <body>
    <%
		List<Doctor> list = DoctorDao.getAllData();
	%>
        <%
		Patient p = null;
		if (session != null) {
		...
		<div class="basic-breadcrumb-area bg-opacity bg-1 ptb-100">
			<div class="container">
				<div class="basic-breadcrumb text-center">
					<h3 class="">Our Awesome Doctors</h3>
					...
					<div class="col-sm-6 col-md-4 mb-30">
						<div class="doctor-box">
							...
							<div class="doctor-name">
								<a href=""><%=d.getFname() %>&nbsp<%=d.getLname() %></a>
								<span class="doctor-desig"><%=d.getSpecialization() %></span>
							</div>
							<hr class="hr-1">
							...
							<input type="submit" name="action" value="profile" class="btn btn-black btn-sm" >
								<a href="book-appointment-form.jsp?id=<%=d.getId() %>" class="btn btn-primary btn-sm" >Booking</a>
								</form>
							</div>
						</div>
					</div>

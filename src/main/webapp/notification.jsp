...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:31 GMT -->
      ...
      <li class="mm-active">
        ...
        <ul>
          ...
          <li class="mm-active"><a href="#">Components</a>
              <ul>
                  <li><a class="active" href="notification.html">Notifications</a></li>

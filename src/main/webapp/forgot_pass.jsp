...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/forgot_pass.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:29 GMT -->
    ...
    <ul id="sidebar_menu">
        ...
        <li class="mm-active">
          ...
          <ul>
            ...
            <li><a class="active" href="forgot_pass.html">Forgot Password</a></li>
          </ul>
        </li>

...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/Input_Selects.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:33 GMT -->
  ...
  <ul id="sidebar_menu">
      ...
      <li class="mm-active">
        ...
        <ul>
          ...
          <li class="mm-active"><a href="#">Widgets</a>
              <ul>
                  <li><a class="active" href="Input_Selects.html">Input Selects</a></li>

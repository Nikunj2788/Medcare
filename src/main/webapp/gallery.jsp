...
<html class="no-js" lang="">
    ...
    <body>
		...
		<div class="basic-portfolio-area ptb-90">
			<div class="container">
				<div class="filter-menu mb-40">
					<button class="active" data-filter="*">ALL</button>
					<button data-filter=".cat1">Doctors </button>
					<button data-filter=".cat2">Treatment</button>
					<button data-filter=".cat3">Laboratory </button>
					<button data-filter=".cat4">Events</button>
				</div>			
				<div id="portfolio-grid" class="row-portfolio">
					<div class="portfolio-item cat3 cat2">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div class="view-icon">
									<a class="popup-link" href="img/portfolio/1.jpg"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
							<div class="portfolio-caption">
								<h4><a href="portfolio-single.html">Basic Gallery Tile</a></h4>
								<div class="work-tag">
									<p>Doctors</p>
								</div>
							</div>
					...
					<div class="portfolio-item cat1 cat4">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div class="view-icon">
									<a class="popup-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"><i class="fa fa-play-circle" aria-hidden="true"></i></a>									
								</div>
							</div>
							<div class="portfolio-caption">
								<h4><a href="portfolio-single.html">Basic Gallery Tile</a></h4>
					...
					<div class="portfolio-item cat2 cat1">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								<img src="img/portfolio/3.jpg" alt="" />
								<div class="view-icon">
									<a class="popup-link" href="img/portfolio/3.jpg"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
							<div class="portfolio-caption">
								<h4><a href="portfolio-single.html">Basic Gallery Tile</a></h4>
					...
					<div class="portfolio-item cat4 cat2">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div class="view-icon">
									<a class="popup-link" href="img/portfolio/4.jpg"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
							<div class="portfolio-caption">
								<h4><a href="portfolio-single.html">Basic Gallery Tile</a></h4>
					...
					<div class="portfolio-item cat1 cat2">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div class="view-icon">
									<a class="popup-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"><i class="fa fa-play-circle"></i></a>
								</div>
							</div>
							<div class="portfolio-caption">
								<h4><a href="portfolio-single.html">Basic Gallery Tile</a></h4>
					...
					<div class="portfolio-item cat2 cat3">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div class="view-icon">
									<a class="popup-link" href="img/portfolio/6.jpg"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
							<div class="portfolio-caption">
								<h4><a href="portfolio-single.html">Basic Gallery Tile</a></h4>
					...
					<div class="portfolio-item cat3">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div class="view-icon">
									<a class="popup-link" href="img/portfolio/7.jpg"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
							<div class="portfolio-caption">
								<h4><a href="portfolio-single.html">Basic Gallery Tile</a></h4>
					...
					<div class="portfolio-item cat4 cat1">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								<img src="img/portfolio/8.jpg" alt="" />
								<div class="view-icon">
									<a class="popup-link" href="img/portfolio/8.jpg"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
							<div class="portfolio-caption">
								<h4><a href="portfolio-single.html">Basic Gallery Tile</a></h4>
					...
					<div class="portfolio-item cat3">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div class="view-icon">
									<a class="popup-link" href="img/portfolio/9.jpg"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
							<div class="portfolio-caption">
								<h4><a href="portfolio-single.html">Basic Gallery Tile</a></h4>

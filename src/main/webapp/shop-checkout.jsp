					...
					<div class="col-sm-8 col-sm-offset-2">
						...
						<form method="post" class="m-b-50">
							<div class="row">
								...
								<div class="col-md-12 form-group">
									...
									<input type="email" class="form-control input-lg" placeholder="E-mail Address" value="">
								</div>

								<div class="col-md-12 form-group">
									<label class="sr-only">Country</label>
									<select class="form-control input-lg checkout-select">
								...
								<div class="col-md-12 form-group">
									...
									<input type="text" class="form-control input-lg" placeholder="Street Address" value="">
								</div>
								...
								<div class="col-md-6 form-group">
									...
									<input type="text" class="form-control input-lg" placeholder="City" value="">
								</div>

								<div class="col-md-6 form-group">
									<label class="sr-only">Pastcode</label>
									<input type="text" class="form-control input-lg" placeholder="Pastcode" value="">
								</div>

								<div class="col-md-12 form-group">
									<label class="sr-only">Phone</label>
									<input type="number" class="form-control input-lg" placeholder="Phone" value="">
								</div>
										...
										<td>
											<div class="radio">
												<label>
													...
													<span class="ddd">PayPal</span>
													<span>With what mingled joy and sorrow do I take up the pen to write to my dearest friend.</span>
												</label>
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="radio">
												<label>
													<input type="radio" name="optionsRadios" value="option1" checked>
													<span class="ddd">Direct Bank Transfer</span>
													<span>Thus much I thought proper to tell you in relation to yourself, and to the trust I reposed in you.</span>
												</label>
											</div>
										</td>
									</tr>
						...
						<div class="totals">
							<table class="table totals-table">
								<tbody>
									<tr>
										<td><h5 class="m-0">Subtotal</h5></td>
										<td><h5 class="m-0 color-gray text-right">$702.00</h5></td>
									</tr>
									<tr>
										<td><h5 class="m-0">Shipping</h5></td>
										<td><h5 class="m-0 color-gray text-right">$2.75</h5></td>
									</tr>
									<tr>
										<td><h5 class="m-0">Discount</h5></td>
										<td><h5 class="m-0 color-gray text-right">$102.00</h5></td>
									</tr>
									<tr>
										<td><h4 class="m-0">Total</h4></td>
										<td><h4 class="m-0 text-right">$602.75</h4></td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div class="row">
							<div class="col-sm-6 col-sm-offset-3">
								<a href="#" class="btn btn-round btn-lg btn-block btn-base">Place order</a>
							</div>
						</div>

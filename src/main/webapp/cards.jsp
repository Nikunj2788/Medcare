...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:31 GMT -->
        ...
        <ul>
          ...
          <li class="mm-active"><a href="#">Components</a>
              <ul>
                  ...
                  <li><a class="active" href="cards.html">cards</a></li>
                    ...
                    <div class="white_box mb_30">
                        <div class="box_header ">
                            <div class="main-title">
                                <h3 class="mb-0" >Card 1</h3>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <img src="admin/img/banner.png" class="card-img-top" alt="...">
                            <div class="card-body">

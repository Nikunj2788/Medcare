...
<html class="no-js" lang="">
    ...
    <body>
			...
			<div class="container">
				<div class="basic-breadcrumb text-center">
					...
					<ol class="breadcrumb text-xs">
						...
						<li class="active">patients say</li>
					</ol>
				</div>
			</div>
		</div>	
		...
		<div class="need-doctor ptb-90 theme-bg">
			<div class="container">
				<div class="doctor-text text-center">
					<h5>contact@Medifine.com</h5>
					<h2>+55 55 555 5555</h2>
					<h6>405 4th Ave New York,  NY 10017 <br /> United States</h6>
				</div>
			</div>
		</div>

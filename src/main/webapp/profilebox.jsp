...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/profilebox.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:31 GMT -->
    ...
    <ul id="sidebar_menu">
        ...
        <li class="mm-active">
          ...
          <ul>
            ...
            <li><a class="active" href="profilebox.html">Profile Box</a></li>
          </ul>
        </li>
                ...
                <div class="col-md-6">
                    <div class="white_box mb_30">
                        ...
                        <div class="profile-cart_2">
                            <div class="images"><img src="admin/img/card.jpg" alt=""></div>
                            <h1>Araaf Kling</h1>
                    ...
                    <div class="white_box mb_30">
                        ...
                        <div class="profile_card_5">
                            <div class="cover-photo">
                              <img src="admin/img/card.jpg" class="profile">
                            </div>
...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/profilebox.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:32 GMT -->
</html>
    ...
    <body>
		...
		<div class="slider-area">
			<div class="slider-active owl-carousel">
				<div class="single-silder appoin-bottom pt-140 pb-300 hero-slide " style="background-image: url('img/slider/6.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-md-8">
								<div class="slider-text text-animation mb-150">
				...
				<div class="single-silder appoin-bottom pt-140 pb-300 hero-slide" style="background-image: url('img/slider/slider-1.jpg')">
					<div class="container">
						<div class="slider-text text-animation text-center mb-150">
			...
			<div class="appointment-area appointment-area-3 hidden-xs">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<div class="quick-appointment-form appointment-form-3">
		...
		<div class="video-area ptb-150 bg-1">
			<div class="video-icon-view text-center">
				<a class="play-btn popup-video" href="https://www.youtube.com/watch?v=IeSW2Gg1qIY"><i class="fa fa-play"></i></a>
			</div>
		</div>		
		<!-- video-area end -->
		<!-- department-area start -->
		<div class="department-area pt-90 pb-60">
			<div class="container">	
				<div class="area-title text-center">
					<h2>Awesome Department</h2>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi tempora veritatis nemo aut ea iusto eos est expedita, quas ab adipisci.</p>
				</div>			
				<div class="row">
					<div class="col-md-4 col-sm-4 mb-30">
						<div class="department-box dep-style-2 text-center">
							<div class="icon-box">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-3 mb-30">
						...
						<div class="pricing-table">
							<div class="pricing-title">
								<h6>Basic Health Plan</h6>
								<em class="text-small">basic plan</em>
							</div>
					...
					<div class="col-sm-3 mb-30">
						...
						<div class="pricing-table">
							<div class="pricing-title">
								<h6>Child Health Plan</h6>
								<em class="text-small">new plan</em>
							</div>
							<div class="pricing-price">
								<span class="price-unit montserrat"><span>$</span>29</span>
								<span class="price-tenure">/mo</span>
							</div>
							<div class="pricing-features">
								<ul>
					...
					<div class="col-sm-3 mb-30">
						...
						<div class="pricing-table">
							<div class="pricing-title">
								<h6>Adult Health Plan</h6>
								<em class="text-small">most popular plan</em>
							</div>
							<div class="pricing-price">
								<span class="price-unit montserrat"><span>$</span>59</span>
								<span class="price-tenure">/mo</span>
							</div>
							<div class="pricing-features">
								<ul>
					...
					<div class="col-sm-3 mb-30">
						...
						<div class="pricing-table">
							<div class="pricing-title">
								<h6>Mature Health Plan</h6>
								<em class="text-small">smart plan</em>
							</div>
							<div class="pricing-price">
		...
		<div class="appointment-area ptb-90">
			<div class="container">
				<div class="appointment-text text-center">
					...
					<a href="#" class="btn btn-default">Book appoinment</a>
				</div>
			</div>
		</div>	

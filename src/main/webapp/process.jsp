				...
				<div class="row">
					<div class="col-md-3 col-sm-6 mb-30">
						<div class="process-item text-center">
							...
							<div class="process-item-content">
								...
								<h3 class="process-item-title">Download our App</h3>
					...
					<div class="col-md-3 col-sm-6 mb-30">
						<div class="process-item text-center highlight">
							...
							<div class="process-item-content">
								...
								<h3 class="process-item-title">Fill your details</h3>
								<p>Behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 mb-30">
						<div class="process-item text-center">
							...
							<div class="process-item-content">
								...
								<h3 class="process-item-title">Confirmation Call</h3>
								<p>Behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 mb-30">
						...
						<div class="process-item-content">
							...
							<h3 class="process-item-title">Meet Your Doctor</h3>
							<p>Behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
						</div>
						</div>
					</div>

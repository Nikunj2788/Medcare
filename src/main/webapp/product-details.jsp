					...
					<div class="col-sm-6 col-xs-12">
						<div class="large-product">
						  ...
						  <ul class="large-product-tab" role="tablist">
							<li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab"><img src="img/product/1.jpg" alt="" /></a></li>
							<li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><img src="img/product/2.jpg" alt="" /></a></li>
							<li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/3.jpg" alt="" /></a></li>
							<li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab"><img src="img/product/4.jpg" alt="" /></a></li>
						  </ul>

						  <!-- Tab panes -->
						  <div class="tab-content large-img-content">
							<div role="tabpanel" class="tab-pane active" id="home"><img src="img/product/1.jpg" alt="" /></div>
							<div role="tabpanel" class="tab-pane" id="profile"><img src="img/product/2.jpg" alt="" /></div>
							<div role="tabpanel" class="tab-pane" id="messages"><img src="img/product/3.jpg" alt="" /></div>
							<div role="tabpanel" class="tab-pane" id="settings"><img src="img/product/4.jpg" alt="" /></div>
						  </div>
						</div>						
					</div>
					<div class="col-sm-6 col-xs-12">
						<div class="product-description mb-30">
							<h2 class="m-b-5">Medifine Product Title</h2>

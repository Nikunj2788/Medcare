...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/mail_box.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:29 GMT -->
 ...
 <nav class="sidebar">
    ...
    <ul id="sidebar_menu">
        ...
        <li class="mm-active">
          ...
          <ul>
            <li><a class="active" href="mail_box.html">Mail Box</a></li>
    ...
    <div class="main_content_iner ">
        <div class="container-fluid p-0">
            <div class="row justify-content-center">
              <div class="col-md-3">
                <div class="text-left">
                    <button class="btn_1 mb-2 btn-lg email-gradient gradient-9-hover email__btn waves-effect"><i class="icon-pencil"></i>COMPOSE</button>
                </div>
                <div class="email-sidebar">
                    ...
                    <ul class="text-left">
                        <li class="text-left"><a href="#"><i class="ti-pin2"></i>Spam</a></li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media align-items-center">
                                            <img class="circle-rounded mr-3" src="admin/img/messages/1.png" alt="" width="30" height="30"> 
...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/mail_box.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:30 GMT -->
</html>
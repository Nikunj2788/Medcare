...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/progress.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:31 GMT -->
  ...
  <ul id="sidebar_menu">
      ...
      <li class="">
        ...
        <ul>
          ...
          <li><a href="admin/index_2.html">Dashboard 2</a></li>
        </ul>
        ...
        <ul>
          ...
          <li class="mm-active"><a href="#">Components</a>
              <ul>
                  ...
                  <li><a class="active" href="progress.html">Progress Bar</a></li>
      ...
      <li class="">
        <a   class="has-arrow" href="#" aria-expanded="false">
          <img src="iadmin/mg/menu-icon/6.svg" alt="">
          <span>Forms</span>
        </a>
        <ul>
          <li><a href="#">Elements</a>

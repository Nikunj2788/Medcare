    ...
    <body>
		...
		<div class="slider-area">
			<div class="slider-style-fix">
				<div class="single-silder slider-apoin ptb-120" style="background-image: url('img/slider/1.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-md-8">
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 mb-40">
						<div class="service-box">
							...
							<div class="service-content">
								<h3><a href="service-details.html">Teeth whitening system.</a></h3>
					...
					<div class="col-md-4 col-sm-6 mb-40">
						<div class="service-box">
							...
							<div class="service-content">
								<h3><a href="service-details.html">Laboratory.</a></h3>
								<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-6 mb-40">
						<div class="service-box">
							...
							<div class="service-content">
								<h3><a href="service-details.html">Additional Treatments.</a></h3>
								<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
							</div>
						</div>
					</div>

			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2">
						<form action="PatientController" method="post" name="form">
						
							<div class="row">
								<input type="hidden" name="id" value=<%=p.getId() %>>
								<div class="col-md-6 form-group">
									<label class="sr-only">Profile Picture</label>
									 <img src="img/patient/<%=p.getImage()%>" width=250px height=250px/>
									<p class="help-block text-danger"></p>
								</div>

								<div class="col-md-6 form-group">
									<label class="sr-only">First Name</label>
									<input type="text" class="form-control input-lg" name="fname" value=<%=p.getFname() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Last Name</label>
									<input type="text" class="form-control input-lg" name="lname" value=<%=p.getLname() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Email</label>
									<input type="email" class="form-control input-lg" name="email" value=<%=p.getEmail() %> >
									<p class="help-block text-danger"></p>
								</div>
									<div class="col-md-6 form-group">
									<label class="sr-only">Contact</label>
									<input type="text" class="form-control input-lg" name="contact" value=<%=p.getContact() %>>
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Age</label>
									<input type="text" class="form-control input-lg" name="age" value=<%=p.getAge() %> >
									<p class="help-block text-danger"></p>
								</div>
									<div class="col-md-6 form-group">
									<label class="sr-only">Address</label>
									<input type="text" class="form-control input-lg" name="address" value=<%=p.getAddress() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">BirthDate</label>
									<input type="text" class="form-control input-lg" name="birthdate" value=<%=p.getBirthdate() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Bloodgroup</label>
									<input type="text" class="form-control input-lg" name="bloodgroup" value=<%=p.getBloodgroup() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Disease</label>
									<input type="text" class="form-control input-lg" name="disease" value=<%=p.getDisease() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Password</label>
									<input type="text" class="form-control input-lg" name="password" value=<%=p.getPassword()%> >
									<p class="help-block text-danger"></p>
								</div>

    ...
    <body>
		...
		<div class="slider-area">
			<div class="slider-active owl-carousel">
				<div class="single-silder height-vh hero-slide " style="background-image: url('img/slider/1.jpg')">
					<div class="container">
				...
				<div class="single-silder height-vh hero-slide " style="background-image: url('img/slider/3.jpg')">
					<div class="container">
						<div class="display-table">
							<div class="table-cell">
				...
				<div class="row">
					<div class="col-sm-4 col-md-4 hidden-sm">
						<div class="features-img">
							<img src="img/doctor-bg-2.jpg" class="img-responsive" alt="">
						</div>
					</div>
					<div class="col-sm-6 col-md-4">
						...
						<div class="feature-box right">
							...
							<div class="text">
								<h4 class="heading">Emergency Services</h4>
								<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.</p>
							</div>
						</div>
						<div class="feature-box right">
					...
					<div class="col-sm-6 col-md-4">
						...
						<div class="feature-box right">
							...
							<div class="text">
								<h4 class="heading">Excellent Support Staff</h4>
								<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.</p>
							</div>
						</div>
						<div class="feature-box right">
							...
							<div class="text">
								<h4 class="heading">Advanced Machines</h4>
								<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.</p>
							</div>
						</div>
					</div>					
			...
			<div class="container">	
				...
				<div class="row">
					<div class="col-sm-6 col-md-4 mb-30">
						<div class="doctor-box">
							<div class="doctor-img">    
								<img src="img/team/doctor-small-1.jpg" class="img-circle" alt="">
							</div>
					...
					<div class="col-sm-6 col-md-4 mb-30">
						<div class="doctor-box">
							<div class="doctor-img">    
								<img src="img/team/doctor-small-2.jpg" class="img-circle" alt="">
							</div>
							<div class="doctor-name">
								<h4 class="heading">Mr. Roberto Blackwell</h4>
								<span class="doctor-desig">Head Of Department</span>
					...
					<div class="col-sm-6 col-md-4 mb-30">
						<div class="doctor-box">
							<div class="doctor-img">    
								<img src="img/team/doctor-small-3.jpg" class="img-circle" alt="">
							</div>
							<div class="doctor-name">
								<h4 class="heading">Mr. Roberto Blackwell</h4>
								<span class="doctor-desig">Head Of Department</span>

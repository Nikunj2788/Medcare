						...
						<form action="DoctorController" method="post" name="form">
							...
							<div class="col-md-6 form-group">
									<label class="sr-only">Profile Picture</label>
									 ...
									 <img src="img/doctor/<%=d.getImage()%>" width=250px height=250px/>
									
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">First Name</label>
									<input type="text" class="form-control input-lg" name="fname" value=<%=d.getFname() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Last Name</label>
									<input type="text" class="form-control input-lg" name="lname" value=<%=d.getLname() %> >
									<p class="help-block text-danger"></p>
								</div>
							
								<div class="col-md-6 form-group">
									<label class="sr-only">Age</label>
									<input type="text" class="form-control input-lg" name="age" value=<%=d.getAge() %> >
									<p class="help-block text-danger"></p>
								</div>
									<div class="col-md-6 form-group">
									<label class="sr-only">Address</label>
									<input type="text" class="form-control input-lg" name="address" value=<%=d.getAddress() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">BirthDate</label>
									<input type="text" class="form-control input-lg" name="birthdate" value=<%=d.getBirthdate() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Experience</label>
									<input type="text" class="form-control input-lg" name="experience" value=<%=d.getExperience() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Speciality</label>
									<input type="text" class="form-control input-lg" name="specialization" value=<%=d.getSpecialization() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Bloodgroup</label>
									<input type="text" class="form-control input-lg" name="bloodgroup" value=<%=d.getBloodgroup() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Qualification</label>
									<input type="text" class="form-control input-lg" name="qualification" value=<%=d.getQualification() %> >
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Contact</label>
									<input type="text" class="form-control input-lg" name="contact" value=<%=d.getContact() %>>
									<p class="help-block text-danger"></p>
								</div>
								<div class="col-md-6 form-group">
									<label class="sr-only">Email</label>
									<input type="email" class="form-control input-lg" name="email" value=<%=d.getEmail() %> >
									<p class="help-block text-danger"></p>
								</div>
								...
								<input type="submit" name="action" value="update" class="btn btn-lg btn-round btn-dark">

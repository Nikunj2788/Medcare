	...
	<div class="slider-area">
		<div class="slider-active owl-carousel">
			<div class="single-silder height-vh hero-slide "
				style="background-image: url('img/slider/Bg-0.jpg')">
				<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 mb-30">
					<div class="features-box border-box text-center">
						...
						<h3>Motivational Videos and Books</h3>
						<p>Behind the word mountains, far from the countries Vokalia
							and Consonantia.</p>
						<a class="btn" href="#">Learn More</a>
					</div>
					...
					<div class="team-item">
						...
						<div class="team-info">
							<h4 class="team-item-name">
								<a href="doctor-details.jsp" name="action" value="edit"></a>
							</h4>
							<span class="team-item-role"></span>
						</div>
					</div>
				</div>
				 <div class="col-sm-6 col-md-3">

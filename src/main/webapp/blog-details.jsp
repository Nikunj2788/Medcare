				...
				<div class="row">
					<div class="col-md-3 col-xs-12">
						...
						<div class="widget">
							...
							<ul class="icons-list">
								<li><a href="#">Journey <span class="pull-right">112</span></a></li>
								<li><a href="#">Development <span class="pull-right">86</span></a></li>
								<li><a href="#">Sport <span class="pull-right">10</span></a></li>
								<li><a href="#">Photography <span class="pull-right">144</span></a></li>
								<li><a href="#">Symphony <span class="pull-right">18</span></a></li>
							</ul>
						</div>
						<div class="widget">
							<h6 class="text-uppercase widget-title">Simple Text</h6>
							...
							<ul class="recent-posts">
								<li>
									<div class="widget-posts-image">
										<a href="#"><img src="img/blog/widgets/1.jpg" alt=""></a>
									</div>
								...
								<li>
									<div class="widget-posts-image">
										<a href="#"><img src="img/blog/widgets/2.jpg" alt=""></a>
									</div>
									<div class="widget-posts-body">
								...
								<li>
									<div class="widget-posts-image">
										<a href="#"><img src="img/blog/widgets/3.jpg" alt=""></a>
									</div>
									<div class="widget-posts-body">
					...
					<div class="col-md-9 col-xs-12">
						<article class="post format-image bg-white">
							...
							<div class="post-content post-no-pad">
								<h2 class="post-title"><a href="#">kidz Medifine services pediatric cardiology</a></h2>
								<ul class="post-meta">
						...
						<!-- COMMENTS -->
						<div class="comments">
							<h5 class="montserrat text-uppercase bottom-line">20 Comments</h5>
							<!-- COMMENT 1 -->
							<div id="comment-1" class="comment">
								...
								<div class="comment-tools">
									<a href="#" data-toggle="tooltip" title="October 24, 2015"><i class="fa fa-clock-o" aria-hidden="true"></i></a>
									<a href="#comment-form" class="smoothscroll" data-toggle="tooltip" title="Reply"><i class="fa fa-reply" aria-hidden="true"></i></a>
								</div>
						...
						<div class="comment-form">
							<h5 class="montserrat text-uppercase bottom-line">Leave a comment</h5>

...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/index_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Sep 2021 04:05:29 GMT -->
    ...
    <ul id="sidebar_menu">
        ...
        <li class="mm-active">
          ...
          <ul>
            ...
            <li><a class="active" href="index_2.html">Dashboard 2</a></li>
          </ul>
